...
var handleImageGen = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, rid, templateUri, clientIFS, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, rid = _a.rid, templateUri = _a.templateUri;
            ...
            case 1:
                ...
                console.log("rid:", rid);
                return [4 /*yield*/, clientIFS.SwapId(templateUri, rid, function (uri) {
                        ...
                        return __generator(this, function (_a) {
                            ...
                            res.json(value === null || value === void 0 ? void 0 : value.proxy_url);
                            return [2 /*return*/];
                        });
                    }); })
                        .finally(function () {

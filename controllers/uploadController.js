...
function saveImage(clientIFS, imageUrl) {
    return __awaiter(this, void 0, void 0, function () {
        var saveid;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, clientIFS.Connect()];
                case 1:
                    _a.sent();
        ...
        switch (_a.label) {
            case 0:
                ...
                if (!url) {
                    ...
                    return [2 /*return*/, next(new errorModel_1.default("Please upload an image.", 403))];
                }
                return [4 /*yield*/, saveImage(clientIFS, url)];
            case 1:
                saveid = _a.sent();
                clientIFS.Close();
                console.log(saveid);

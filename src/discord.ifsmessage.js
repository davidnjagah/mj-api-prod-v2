...
exports.IFSDiscordMessage = void 0;
var interfaces_1 = require("./interfaces");
var utils_1 = require("./utils");
var async = require("async");
var IFSDiscordMessage = /** @class */ (function () {
    function IFSDiscordMessage(defaults) {
        var _this = this;
    ...
    IFSDiscordMessage.prototype.log = function () {
        var args = [];
    ...
    IFSDiscordMessage.prototype.FilterMessages = function (timestamp, rid, loading) {
        return __awaiter(this, void 0, void 0, function () {
            var data, i, item, itemTimestamp, uri, progress, content, proxy_url, msg;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.safeRetrieveMessages(this.config.Limit)];
                    case 1:
                        data = _a.sent();
                        for (i = 0; i < data.length; i++) {
                            item = data[i];
                            if (item.author.id === this.config.BotId &&
                                item.content.includes("".concat(rid))) {
    ...
    IFSDiscordMessage.prototype.content2progress = function (content) {
    ...
    IFSDiscordMessage.prototype.UriToHash = function (uri) {
        var _a, _b;
        return (_b = (_a = uri.split("_").pop()) === null || _a === void 0 ? void 0 : _a.split(".")[0]) !== null && _b !== void 0 ? _b : "";
    };
    IFSDiscordMessage.prototype.WaitIFSMessage = function (rid, loading, timestamp) {
        return __awaiter(this, void 0, void 0, function () {
            var i, msg;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.FilterMessages(timestamp, rid, loading)];
                    case 2:
                        msg = _a.sent();
                        if (msg !== null) {
                            return [2 /*return*/, msg];
    ...
    IFSDiscordMessage.prototype.WaitSaveIdMessage = function (saveid, loading, timestamp) {
        return __awaiter(this, void 0, void 0, function () {
            var i, msg;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    IFSDiscordMessage.prototype.WaitSwapIdMessage = function (imageUri, loading, timestamp) {
        return __awaiter(this, void 0, void 0, function () {
            var i, msg;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    IFSDiscordMessage.prototype.RetrieveMessages = function (limit) {
    ...
    return IFSDiscordMessage;
}());
exports.IFSDiscordMessage = IFSDiscordMessage;
